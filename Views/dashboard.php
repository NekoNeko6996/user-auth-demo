...
<body>
  <aside class="aside-left">
    ...
    <div class="aside-option-container">
      ...
      <!--  -->
      <div class="aside-pages" onclick="loadBody('profile', this)">
        <svg width="28px" height="28px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
  ...
  <div class="container">
    ...
    <nav class="top-nav">
      <div class="nav-user-info-container">
        <div class="nav-user-info" for="show-hide-user-options">
          <p>Nguyễn Hoàng Nam</p>
          <img src="../users/imgs/avatars/default_user_avatar.jpg" alt="user avatar">
        </div>
        <div class="nav-user-options">
          <button>Profile</button>
          <button>Settings</button>
          <button onclick="window.location.href = '../Server/api/logoutController.php'">Logout</button>
        </div>
      </div>
    </nav>
